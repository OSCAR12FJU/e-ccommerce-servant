...
export const CartIcon: React.FC<IconProps> = ({className = ""}) =>(
  <svg xmlns="http://www.w3.org/2000/svg" className={`${className}`}viewBox="0 0 24 24" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" stroke="#ffbe00"> 
